...
| Canonical client template (index/styles/script/site.config pattern) | oxigen-fitness-digital | **TEMPLATE** | Roll to 7 remaining clients; new client = 1 config file + accent flavor | Config slots: contact/plans/trainers/classes/reviews/UPI |
